...
if __name__ == "__main__":
    ...
    print(id(Demo1._Demo1__var_private), Demo1._Demo1__var_private) # use the mangled name to access the private attribute
    ...
    #b.__fn_private()
    b._Demo2__fn_private() # not override, due to still access the parent function (mangled name)
    b._Demo1__fn_private() # the parent function (mangled name)

    c = __Demo3() # should be unable to be access, if the class is separated into the new class file.
    c.fn_public()
